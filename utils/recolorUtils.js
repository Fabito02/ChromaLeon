...
export async function applyAccentTheme(baseColor, options = {}, cancellable) {
  ...
  const colorMap = {
    ...
    "14498a": modifyColor(baseColor, -0.20, -0.05),
    "1e77e1": modifyColor(baseColor, -0.08, 0.0),
    "1966c2": modifyColor(baseColor, -0.16, -0.02),
    d3e3f9: modifyColor(baseColor, 0.35, 0.015),
    b3d3f9: modifyColor(baseColor, 0.27, 0.08),
    cc9c54: modifyColor(baseColor, -0.08, 0.0),
    d5ae73: modifyColor(baseColor, 0.08, 0.0),
    cc920a: modifyColor(baseColor, -0.08, 0.0),
    ce9508: modifyColor(baseColor, -0.08, 0.0),
    ce9708: modifyColor(baseColor, -0.08, 0.0),
  ...
  const rebelApps = {
    ...
    "org.gnome.Geary.svg": {
      f6d32d: modifyColor(baseColor, 0.0, 0.0),
      f5c211: modifyColor(baseColor, -0.04, 0.0),
      e5a50a: modifyColor(baseColor, -0.09, 0.0),
      c18b08: modifyColor(baseColor, -0.16, -0.05),
      cc920a: modifyColor(baseColor, -0.12, 0.0),
      ce9508: modifyColor(baseColor, -0.12, 0.0),
      ce9708: modifyColor(baseColor, -0.12, 0.0),
    },
    "com.mattjakeman.ExtensionManager.svg": {
